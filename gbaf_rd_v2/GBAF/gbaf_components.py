...
from GBAF.attention import AttentionLayer
from GBAF.utils import get_layers
...
class Encoder(nn.Module):
    def __init__(self, input_size, m, attention_size, num_layers, num_head, dropout, output_size=1):
        ...
        self.fe = GBAF_FeatureExtracture(input_size, attention_size, scale=3)
...
class GBAF_FeatureExtracture(nn.Module):
    def __init__(self, input_size, output_size, scale=3):
        super(GBAF_FeatureExtracture,self).__init__()
